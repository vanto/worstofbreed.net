...
## Analysis
You take the easy path to the force. Create one abstract class with some template methods and start subclassing! Until you find yourself that you are not able to change anything, then you feel yourself on the dark side.
